...
bool GraphicsClass::Initialize(OpenGLClass* OpenGL, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_OpenGL,  "../GL4.0/data/cube.txt", "../GL4.0/data/opengl.tga", 0, true);
	if(!result)
	{
	...
	result = m_LightShader->Initialize(m_OpenGL, hwnd, "../GL4.0/light_vs.glsl", "../GL4.0/light_ps.glsl");
	if(!result)
	{
