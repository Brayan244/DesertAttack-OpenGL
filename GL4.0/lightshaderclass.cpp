...
bool LightShaderClass::Initialize(OpenGLClass* OpenGL, HWND hwnd, char* vertexShader, char* pixelShader)
{
	bool result;


	// Initialize the vertex and pixel shaders.
	//result = InitializeShader("../GL4.0/light_vs.glsl", "../GL4.0/light_ps.glsl", OpenGL, hwnd);
	result = InitializeShader(vertexShader, pixelShader, OpenGL, hwnd);
	if(!result)
	{
		return false;
	}
...
bool LightShaderClass::SetShaderParameters(OpenGLClass* OpenGL, Matrix4f worldMatrix, Matrix4f viewMatrix, Matrix4f projectionMatrix, int textureUnit, float* lightDirection, float* diffuseLightColor, float* ambientLight)
{
